...
b.style.backgroundColor = "#1C1C1F";
...
function previewCreation(arr) {
    ...
    for (var i = 0; i < arr.length; i++) {
        ...
        attributeCreation("title", 'Click to details', item);
        ...
        attributeCreation("title", arr[i].country, countryImg);
        ...
        attributeCreation("title", arr[i].model, model);
...
function detailsCreation(arr) {
    ...
    attributeCreation("title", currentModel.country, countryImg);
    model = document.createElement('span');
